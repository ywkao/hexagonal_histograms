...
std::pair<double, double> HGCalCell::cellUV2XY2(int32_t u, int32_t v, int32_t placementIndex, int32_t type) {
  ...
  if (placementIndex < HGCalCell::cellPlacementExtra) {
    ...
    std::vector<double> fcos = {1.0, 0.5, -0.5, -1.0, -0.5, 0.5};
    std::vector<double> fsin = {0.0, sqrt3By2_, sqrt3By2_, 0.0, -sqrt3By2_, -sqrt3By2_};
    ...
    std::vector<double> fcos = {0.5, 1.0, 0.5, -0.5, -1.0, -0.5};
    std::vector<double> fsin = {sqrt3By2_, 0.0, -sqrt3By2_, -sqrt3By2_, 0.0, sqrt3By2_};
...
std::pair<int, int> HGCalCell::cellUV2Cell(int32_t u, int32_t v, int32_t placementIndex, int32_t type) {
  ...
  if (placementIndex >= HGCalCell::cellPlacementExtra) {
    std::vector<int> itype0 = {0, 7, 8, 9, 10, 11, 6, 3, 4, 5, 4, 5, 3};
    std::vector<int> itype1 = {0, 0, 1, 2, 3, 4, 5, 0, 1, 2, 0, 1, 2};
    std::vector<int> itype2 = {0, 11, 6, 7, 8, 9, 10, 5, 3, 4, 3, 4, 5};
    std::vector<int> itype3 = {0, 4, 5, 0, 1, 2, 3, 2, 0, 1, 2, 0, 1};
    std::vector<int> itype4 = {0, 9, 10, 11, 6, 7, 8, 4, 5, 3, 5, 3, 4};
    std::vector<int> itype5 = {0, 2, 3, 4, 5, 0, 1, 1, 2, 0, 1, 2, 0};
    if (u == 0 && v == 0) {
      cellx = 1;
    ...
    std::vector<int> itype0 = {0, 1, 2, 3, 4, 5, 0, 1, 2, 0, 0, 1, 2};
    std::vector<int> itype1 = {0, 8, 9, 10, 11, 6, 7, 4, 5, 3, 4, 5, 3};
    std::vector<int> itype2 = {0, 3, 4, 5, 0, 1, 2, 2, 0, 1, 1, 2, 0};
    std::vector<int> itype3 = {0, 10, 11, 6, 7, 8, 9, 5, 3, 4, 5, 3, 4};
    std::vector<int> itype4 = {0, 5, 0, 1, 2, 3, 4, 0, 1, 2, 2, 0, 1};
    std::vector<int> itype5 = {0, 6, 7, 8, 9, 10, 11, 3, 4, 5, 3, 4, 5};
    if (u == 0 && v == 0) {
      cellx = 1;
      cellt = HGCalCell::cornerCell;
...
std::pair<int32_t, int32_t> HGCalCell::cellType(int32_t u, int32_t v, int32_t ncell, int32_t placementIndex) {
  int cell(0), cellx(0), cellt(HGCalCell::fullCell);
  if (placementIndex >= HGCalCell::cellPlacementExtra) {
    std::vector<int> itype0 = {HGCalCell::centralCell,
    ...
    std::vector<int> itype1 = {HGCalCell::centralCell,
                                     HGCalCell::bottomLeftCorner,
                                     HGCalCell::bottomCorner,
                                     HGCalCell::bottomRightCorner,
                                     HGCalCell::topRightCorner,
                                     ...
                                     HGCalCell::topLeftEdge,
                                     HGCalCell::leftEdge};
    std::vector<int> itype2 = {HGCalCell::centralCell,
                                     HGCalCell::topLeftCorner,
                                     HGCalCell::bottomLeftCorner,
                                     HGCalCell::bottomCorner,
                                     HGCalCell::bottomRightCorner,
                                     ...
                                     HGCalCell::topRightEdge,
                                     HGCalCell::topLeftEdge};
    std::vector<int> itype3 = {HGCalCell::centralCell,
                                     HGCalCell::topCorner,
                                     HGCalCell::topLeftCorner,
                                     HGCalCell::bottomLeftCorner,
                                     HGCalCell::bottomCorner,
                                     ...
                                     HGCalCell::rightEdge,
                                     HGCalCell::topRightEdge};
    std::vector<int> itype4 = {HGCalCell::centralCell,
                                     HGCalCell::topRightCorner,
                                     HGCalCell::topCorner,
                                     HGCalCell::topLeftCorner,
                                     HGCalCell::bottomLeftCorner,
                                     ...
                                     HGCalCell::bottomRightEdge,
                                     HGCalCell::rightEdge};
    std::vector<int> itype5 = {HGCalCell::centralCell,
                                     HGCalCell::bottomRightCorner,
                                     HGCalCell::topRightCorner,
                                     HGCalCell::topCorner,
                                     HGCalCell::topLeftCorner,
